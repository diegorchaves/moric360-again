...
if __name__ == "__main__":
    output = circular_zoom(
        image_path="/home/diego/Desktop/moric360-again/dataset/other_data_set/othim19/data/othim19.png",
    ...
    output.save(
        "/home/diego/Desktop/moric360-again/imgs_fina_zomm_oficil/othim19_original_zoom.png"
    )
    # output.show()
