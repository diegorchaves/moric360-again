...
parser.add_argument(
    "--csv",
    default="/home/diego/Desktop/moric360-again/experiments/vcip_consolidated/results.csv",
)
parser.add_argument(
    "--out",
    default="/home/diego/Desktop/moric360-again/experiments/vcip_consolidated/wsssim_curve.png",
)
...
for scenario, color, marker, ls in zip(scenarios, colors, markers, linestyles):
    ...
    subset = (
        subset.groupby("lambda_rate")[["eval_wsssim", "eval_total_rate_bpp"]]
        .mean()
        .reset_index()
...
ax.set_ylabel("WS-SSIM", fontsize=12)
